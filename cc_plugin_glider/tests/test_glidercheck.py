...
static_files = {
    'glider_std': resource_filename('cc_plugin_glider', 'tests/data/gliders/IOOS_Glider_NetCDF_v2.0.nc'),
    'bad_location': resource_filename('cc_plugin_glider', 'tests/data/gliders/bad_location.nc'),
    'bad_qc': resource_filename('cc_plugin_glider', 'tests/data/gliders/bad_qc.nc'),
    'bad_metadata': resource_filename('cc_plugin_glider', 'tests/data/gliders/bad_metadata.nc'),
}
